...
public static class Toolbox
{
    ...
    public static bool IsChampionOrUltimateEvoEnabled(IEvoCriteria evoCriteria, UserDigimon userDigimon)
    {
        ...
        if (evoCriteria == null) throw new ArgumentNullException(nameof(evoCriteria));

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (userDigimon == null) throw new ArgumentNullException(nameof(userDigimon));

        #endregion

        var NrOfCriteriaMet = 0;

        var CriteriaMetThresholdForEvo = 3;

        var MaxBonusCriteriaMetCount = 1;

        var CriteriaMetThresholdToContinue = CriteriaMetThresholdForEvo - MaxBonusCriteriaMetCount;
    ...
    public static int AmtMainCriteriaMet(EvoCriteriaMain mainEvoCriteria, MainCriteriaStats mainCriteriaStats)
    {
        ...
        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (mainEvoCriteria == null) throw new ArgumentNullException(nameof(mainEvoCriteria));

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (mainCriteriaStats == null) throw new ArgumentNullException(nameof(mainCriteriaStats));

        #endregion

        var amtMainCriteriaMet = 0;

        if (IsCombatStatsCriterionMet(mainEvoCriteria.CombatStats, mainCriteriaStats.CombatStats))
            amtMainCriteriaMet++;

        if (IsWeightCriterionMet(mainEvoCriteria.Weight, mainCriteriaStats.Weight)) amtMainCriteriaMet++;

        if (IsCareMistakeCriterionMet(mainEvoCriteria.CareMistakes, mainCriteriaStats.CareMistakes))
            amtMainCriteriaMet++;

        return amtMainCriteriaMet;
    }

    public static bool IsAnyBonusCriterionMet(EvoCriteriaBonus evoCriteriaBonus,
        BonusCritiaStats BonusCriteriaStats)
    {
        #region Error handling

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriteriaBonus == null) throw new ArgumentNullException(nameof(evoCriteriaBonus));

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (BonusCriteriaStats == null) throw new ArgumentNullException(nameof(BonusCriteriaStats));

        #endregion

        var bonusCriteriaStats = BonusCriteriaStats;
    ...
    public static bool IsHighestCombatStatACriterion(EvoCriterionCombatStats evoCriterionCombatStats,
        CombatStats userDigimonCombatStats)
    {
        #region Error handling

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionCombatStats == null) throw new ArgumentNullException(nameof(evoCriterionCombatStats));

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (userDigimonCombatStats == null) throw new ArgumentNullException(nameof(userDigimonCombatStats));

        #endregion

        var HighestCombatStat = EvoStatsToolbox.GetHighestCombatStatKey(userDigimonCombatStats);
    ...
    public static bool IsCombatStatsCriterionMet(EvoCriterionCombatStats evoCriterionCombatStats,
    ...
    public static bool IsCareMistakeCriterionMet(EvoCriterionCareMistakes evoCriterionCareMistakes,
        int careMistakes)
    {
        #region Error handling

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionCareMistakes == null) throw new ArgumentNullException(nameof(evoCriterionCareMistakes));
    ...
    public static bool IsWeightCriterionMet(EvoCriterionWeight evoCriterionWeight, int weight)
    {
        ...
        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionWeight == null) throw new ArgumentNullException(nameof(evoCriterionWeight));
    ...
    public static bool IsPrecursorCriterionMet(DigimonType? precursorDigimonCriterion,
        DigimonType userDigimonDigimonType)
    {
        #region Error handling

        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (precursorDigimonCriterion == null) throw new ArgumentNullException(nameof(precursorDigimonCriterion));
    ...
    public static bool IsTechniqueCriterionMet(EvoCriterionTech evoCriterionTech, int tech)
    {
        ...
        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionTech == null) throw new ArgumentNullException(nameof(evoCriterionTech));
    ...
    public static bool IsHappinessCriteronMet(EvoCriterionHappiness evoCriterionHappiness, int happiness)
    {
        ...
        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionHappiness == null) throw new ArgumentNullException(nameof(evoCriterionHappiness));
    ...
    public static bool IsDisciplineCriterionMet(EvoCriterionDiscipline evoCriterionDiscipline, int discipline)
    {
        ...
        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionDiscipline == null) throw new ArgumentNullException(nameof(evoCriterionDiscipline));
    ...
    public static bool IsBattleCriterionMet(EvoCriterionBattles evoCriterionBattles, int battles)
    {
        ...
        // Error handling: Throw an exception explicitly stating the parameter that is null.
        if (evoCriterionBattles == null) throw new ArgumentNullException(nameof(evoCriterionBattles));
